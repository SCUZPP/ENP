...
from tool import convert_secs2time, time_string, time_file_str
...
parser.add_argument('-trb', '--train-batch-size', default=512, type=int, metavar='N', help='mini-batch size (default: 64)')
parser.add_argument('-vb', '--val-batch-size', default=512, type=int, metavar='N', help='mini-batch size (default: 256)')
parser.add_argument('-teb', '--test-batch-size', default=512, type=int, metavar='N', help='mini-batch size (default: 256)')
parser.add_argument('-num_classes', '--num-classes', default=1000, type=int, metavar='N', help='mini-batch size (default: 100)')
...
parser.add_argument('--print-freq', '-p', default=20, type=int, metavar='N', help='print frequency (default: 100)')
...
def main():
    ...
    if args.arch.startswith('alexnet') or args.arch.startswith('vgg'):
        ...
        if len(device_ids)>1:
            model=torch.nn.DataParallel(model).cuda();#前
    ...
    #traindir = '../data/train_100'
    #valdir = '../data/val_100'
    #testdir = '../data/test_100'
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        #val_acc_2 = test(test_loader, model, criterion, log)
        # train for one epoch
