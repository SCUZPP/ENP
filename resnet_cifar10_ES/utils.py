...
#微调模型
#epoch设为几呢？10
def train(epoch, train_loader, model, pruner, optimizer, args):
    losses = AverageMeter()
    top1 = AverageMeter()
    eval_loss = 0
    eval_acc = 0
...
def train_forward(train_loader, test_loader, val_loader, model_original, args):
    #只加载一次
    ...
    for epoch in range(0, epochs):
        ...
        train(epoch, train_loader, model, pruner, optimizer, args)
        #test(epoch)
